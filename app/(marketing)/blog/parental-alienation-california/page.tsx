...
export const metadata = {
  ...
  keywords: [
    ...
    "Santa Clarita parental alienation lawyer",
    "730 evaluation parental alienation",
    "Minor's Counsel California",
    "reunification therapy child custody",
    "parental alienation Santa Clarita",
  ],
};

export default function ParentalAlienationBlog() {
  return (
    <>
      ...
      <Section>
        <div className="max-w-3xl mx-auto prose prose-lg text-[#3A3A3A]">
          ...
          <h2>What Is Parental Alienation and How Does It Differ from Normal Estrangement?</h2>
          <p>
          ...
          <ul>
            <li>Persistent badmouthing or negative comments about the targeted parent in the child’s presence</li>
            <li>Interfering with or denying court-ordered parenting time without valid reason</li>
            <li>Encouraging the child to spy on or report back about the other parent</li>
            <li>Making unilateral decisions about the child without consulting the other parent</li>
            <li>Withholding important information about the child’s health, education, or activities</li>
            <li>Creating loyalty conflicts by forcing the child to choose sides</li>
            <li>Sharing inappropriate adult information or court documents with the child</li>
            <li>Encouraging the child to call the targeted parent by their first name instead of “mom” or “dad”</li>
            <li>Threatening or punishing the child for expressing positive feelings about the other parent</li>
            <li>Portraying the targeted parent as dangerous, unstable, or unloving without evidence</li>
          </ul>
          <p>
          ...
          <h2>The Serious Emotional Impact on Children</h2>
          <p>
          ...
          <h2>How Parental Alienation Is Viewed in California Family Courts</h2>
          <p>
          ...
          <h2>Proven Legal Strategies for Parents Facing Suspected Parental Alienation</h2>

          <h3>Document Evidence Effectively</h3>
          <p>
          ...
          <h3>The Importance and Process of 730 Child Custody Evaluations</h3>
          <p>
          ...
          <h3>When and How to Request Minor’s Counsel</h3>
          <p>
          ...
          <h3>Filing Motions for Therapeutic Intervention</h3>
          <p>
          ...
          <h3>Working with Forensic Experts and Reunification Therapists</h3>
          <p>
          ...
          <h3>Courtroom Strategies Under California Law</h3>
          <p>
          ...
          <h2>What NOT to Do: Common Mistakes That Can Hurt Your Case</h2>
          <p>
            Parents facing suspected alienation often make understandable but damaging mistakes:
          </p>
          <ul>
            <li>Retaliating with negative comments about the other parent</li>
            <li>Withholding the child from the other parent without a court order</li>
            <li>Discussing the case or court documents with the child</li>
            <li>Violating court orders in an attempt to “protect” the child</li>
            <li>Making unsubstantiated allegations without evidence</li>
          </ul>
          <p>
