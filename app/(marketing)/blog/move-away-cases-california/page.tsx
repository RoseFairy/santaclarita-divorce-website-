...
export default function MoveAwayCasesBlog() {
  return (
    <>
      ...
      <Section>
        <div className="max-w-3xl mx-auto prose prose-lg text-[#3A3A3A]">
          <h2>What Are Move-Away and Relocation Cases?</h2>
          <p>
          ...
          <h3>In re Marriage of Burgess (1996) 13 Cal.4th 25</h3>
          <p>
            The California Supreme Court’s decision in <em>Burgess</em> established important principles governing relocation. The Court held that a parent who has been awarded physical custody generally has the right to change the residence of the child, subject to the court’s authority to modify custody orders if the move would be detrimental to the child. <em>Burgess</em> emphasized that the child’s best interests remain paramount and that custody orders are always subject to modification based on changed circumstances.
          </p>

          <h3>In re Marriage of LaMusga (2004) 32 Cal.4th 1072</h3>
          <p>
            The landmark <em>LaMusga</em> decision significantly refined the analysis courts must apply in relocation cases. The Supreme Court clarified that while a custodial parent may have the right to relocate, the court must conduct a thorough best-interests analysis that considers the impact of the move on the child’s relationship with the non-moving parent. <em>LaMusga</em> rejected any presumption in favor of the moving parent and required courts to carefully weigh multiple factors before allowing or denying relocation.
          </p>
          ...
          <ul>
            <li><strong>The child’s health, safety, and welfare</strong> — The court examines how the move will affect the child’s overall well-being.</li>
            <li><strong>The nature and amount of contact with both parents</strong> — The existing parenting time schedule and the strength of the child’s bond with each parent are carefully reviewed.</li>
            <li><strong>The reasons for the proposed move</strong> — The court considers whether the move is motivated by legitimate reasons or an attempt to frustrate the other parent’s relationship with the child.</li>
            <li><strong>The distance and likely impact of the move on the child’s relationship with the non-moving parent</strong> — Greater distances generally increase the potential for harm to the parent-child relationship.</li>
            <li><strong>The feasibility of a new visitation schedule</strong> — Courts assess whether a realistic and workable parenting plan can be established after the move.</li>
            <li><strong>The child’s age and any preference they may express</strong> — Older children’s wishes may carry more weight, depending on their maturity.</li>
            <li><strong>Any history of domestic violence or substance abuse</strong> — Safety concerns are always given significant weight in the analysis.</li>
          ...
          <ul>
            <li>Obtaining thorough custody evaluations and expert opinions</li>
            <li>Presenting detailed evidence of the child’s current stability and relationships</li>
            <li>Developing creative, realistic alternative parenting schedules</li>
